import { SystemImageProps } from "@/components/ui/Form";
...
export const Projects: ProjectListItem[] = [
  {
    ...
    image: "/images/docvivo-health/cover.png",
    href: {
    ...
    summary: {
      tr: "Docvivo Sağlık uygulamasını Expo destekli React Native kullanarak geliştirdim. Uygulama, kullanıcıların sağlık verilerini takip edebilmelerini ve bu verileri izinleri doğrultusunda doktorlarıyla paylaşabilmelerini sağlıyor. Doktorlar da kendi panellerinden hastalarının sağlık durumlarını anlık olarak izleyebiliyor.",
  ...
  {
    title: "Docvivo CRM",
    image: "/images/docvivo-crm/cover.png",
    href: {
      pathname: "/project/[slug]",
      params: {
        slug: "docvivo-crm",
  ...
  },
  {
    ...
    image: "/images/docvivo-mobile/cover.png",
    href: {
      pathname: "/project/[slug]",
      params: {
        slug: "docvivo-mobile",
  ...
  {
    title: "Mobilyaka",
    image: "/images/mobilyaka/cover.png",
    href: {
      pathname: "/project/[slug]",
      params: {
        slug: "mobilyaka",
  ...
  {
    title: "Emlak Konut",
    image: "/images/emlak-konut/cover.png",
    href: {
      pathname: "/project/[slug]",
      params: {
        slug: "emlak-konut",
  ...
  {
    title: "Halk Yatırım",
    image: "/images/halk-yatirim/cover.png",
    href: {
      pathname: "/project/[slug]",
      params: {
        slug: "halk-yatirim",
